...
import { FaTwitter, FaMedium, FaInstagram, FaFacebook, FaUser } from "react-icons/fa";
            ...
            <div className="column is-5 is-4-widescreen">
              <article className="media">
                <figure className="media-left">
                  <StaticImage alt="IELSgeek" role="presentation" src='../images/logo.png'
                  placeholder="blurred"
                  layout="fixed"
                  width={64}
                  height={64} />
                ...
                <div className="media-content">
                  <div className="content">
                    <div className="title is-size-4">IELTSgeek</div>
              ...
              <div className="columns">
                <div className="column is-4">
                  <div className="menu">
                    ...
                    <ul className="menu-list">
                      ...
                      <li>
                        <Link to="/technology" activeClassName="is-active">Technology</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="column is-4">
                  <div className="menu">
                    ...
                    <ul className="menu-list">
                      ...
                      <li>
                        <Link to="/about-us" activeClassName="is-active">About Us</Link>
                      </li>
                      <li>
                        <Link to="/privacy-policy" activeClassName="is-active">Privacy</Link>
                      </li>
                      <li>
                        <Link to="/terms-of-use" activeClassName="is-active">Terms</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="column is-4">
                  <div className="menu">
                    ...
                    <ul className="menu-list">
                      <li>
                        <a href="mailto:support@ieltsgeek.com" target="_blank" rel="noreferrer">
                      ...
                      <li>
                        <a
                          href="https://instagram.com/getbedtimestories"
                          target="_blank" rel="noreferrer"
                        >
                      ...
                      <li>
                        <a href={data.site.siteMetadata.medium} target="_blank" rel="noreferrer">
