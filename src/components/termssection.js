    ...
    <div className="container">
      <div className="columns">
        <div className="column is-8">
          <h1 className="title is-size-1">EULA / Terms and conditions</h1>
          <h2 className="subtitle">Last Update: July 27, 2021</h2>

          <h2 className="title">Agreement To Terms</h2>
          <p className="mb-3">
            These Terms and Conditions constitute a legally binding agreement
            made between you, whether personally or on behalf of an entity
            (“you”) and Little Lights Studio GmbH (“we,” “us” or “our”),
            concerning your access to and use of the Bedtime Stories - read &
            tell app as well as any other media form, media channel, mobile
            webpage or mobile application related, linked, or otherwise
            connected thereto (collectively, the “App”). You agree that by
            accessing the App, you have read, understood, and agree to be bound
            by all of these Terms and Conditions Use. IF YOU DO NOT AGREE WITH
          ...
          <h2 className="title">Intellectual Property Rights</h2>
          <p className="mb-3">
            ...
            Austria, foreign jurisdictions, and international conventions. The
            Content and the Marks are provided on the App “AS IS” for your
            information and personal use only. Except as expressly provided in
            these Terms of Use, no part of the App and no Content or Marks may
          ...
          <p className="mb-6">
            Provided that you are eligible to use the App, you are granted a
            limited license to access and use the App and to download or print a
            copy of any portion of the Content to which you have properly gained
            access solely for your personal, non-commercial use. We reserve all
            rights not expressly granted to you in and to the App, Content and
            the Marks.
          </p>

          <h2 className="title">User Representations</h2>
          <p className="mb-3">
            By using the App, you represent and warrant that: [(1) all
            ...
            received parental permission to use the App]; (6) you will not
            access the App through automated or non-human means, whether through
            a bot, script or otherwise; (7) you will not use the App for any
            illegal or unauthorized purpose; and (8) your use of the App will
            not violate any applicable law or regulation.
          </p>
          <p className="mb-6">
            If you provide any information that is untrue, inaccurate, not
            current, or incomplete, we have the right to suspend or terminate
            your account and refuse any and all current or future use of the App
            (or any portion thereof).
          </p>

          <h2 className="title">User Registration</h2>
          <p className="mb-6">
            You may be required to register with the App now or in the
            foreseeable future. You agree to keep your password confidential and
          ...
          <h2 className="title">Prohibited Activities</h2>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            <ol>
              ...
              <li>
                make any unauthorized use of the App, including collecting
          ...
          <h3> Third Party Webpages And Content </h3>
          <p> The App may contain (or you may be sent via the App) links to other webpages ("Third- Party webpages") as well as articles, photographs, text, graphics, pictures, designs, music, sound, video, information, applications, software, and other content or items belonging to or originating from third parties ("Third-Party Content"). Such Third-Party Webpages and Third-Party Content are not investigated, monitored, or checked for accuracy, appropriateness, or completeness by us, and we are not responsible for any Third-Party Webpages accessed through the App or any Third-Party Content posted on, available through, or installed from the App, including the content, accuracy, offensiveness, opinions, reliability, privacy practices, or other policies of or contained in the Third-Party Webpages or the Third-Party Content. Inclusion of, linking to, or permitting the use or installation of any Third-Party Webpages or any Third-Party Content does not imply approval or endorsement thereof by us. If you decide to leave the App and access the Third-Party Webpages or to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Terms of Use no longer govern. You should review the applicable terms and policies, including privacy and data gathering practices, of any webpage to which you navigate from the App or relating to any applications you use or install from the App. Any purchases you make through Third-Party Webpages will be through other webpages and from other companies, and we take no responsibility whatsoever in relation to such purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we do not endorse the products or services offered on Third-Party Webpages and you shall hold us harmless from any harm caused by your purchase of such products or services. Additionally, you shall hold us harmless from any losses sustained by you or harm caused to you relating to or resulting in any way from any Third-Party Content or any contact with Third-Party Webpages. </p>
          ...
          <p> We care about data privacy and security. Please review our Privacy Policy visit <a href="https://ieltsgeek.com/privacy-policy">https://ieltsgeek.com/privacy-policy</a>. By using the App, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. </p>
          ...
          <h3> Governing Law </h3>
          <p> These Terms of Use and your use of the App are governed by and construed in accordance with the laws of the State of Austria applicable to agreements made and to be entirely performed within the State of Austria, without regard to its conflict of law principles. </p>
