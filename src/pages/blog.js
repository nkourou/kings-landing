                    ...
                    <div className="column is-4">
                        <div className="card is-flex is-flex-direction-column">
                            ...
                            <div className="card-content is-flex-grow-1">
                                <div className="media">
                                    ...
                                    <figure className="image is-48x48">
                                        <img src={post.author.picture.url} alt="IELTSgeek logo" className="is-rounded"/>
                                    </figure>
                                    </div>
                                    <div className="media-content">
                                        <p className="title is-size-5">
                                        <Link to={`/blog/${slug}`} className="blog-title-link">{post.title}</Link>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="card-content">
                                ...
                                <span className="help">Published on <time date={post.date}>{post.date}</time></span>
                            </div>
                        </div>
                    </div>
                ))}    
